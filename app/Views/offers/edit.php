 ...
 */
$page_title = 'Aanbieding Bewerken';
...
<div class="max-w-2xl mx-auto">
    ...
    <h1 class="text-2xl font-bold text-gray-900 mb-6">Aanbieding Bewerken</h1>
    ...
    <form method="POST" action="/offers/<?= $offer['id'] ?>" class="bg-white rounded-lg shadow p-6 space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input 
                    ...
                    name="plan_name" 
                    required 
                    value="<?= esc_attr($offer['plan_name']) ?>"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select 
                    ...
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
                    <option value="monthly" <?= $offer['frequency'] === 'monthly' ? 'selected' : '' ?>>Maandelijks</option>
                    <option value="yearly" <?= $offer['frequency'] === 'yearly' ? 'selected' : '' ?>>Jaarlijks</option>
                </select>
            </div>
        </div>
        ...
        <div>
            ...
            >
                ...
                <?php foreach ($categories as $cat): ?>
                    <option value="<?= esc_attr($cat['name']) ?>" <?= ($offer['category'] ?? '') === $cat['name'] ? 'selected' : '' ?>>
                        <?= esc_html($cat['name']) ?>
                    </option>
                <?php endforeach; ?>
            </select>
        ...
        <div>
            ...
            <textarea 
                ...
                rows="3" 
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ><?= esc_html($offer['description'] ?? '') ?></textarea>
        </div>
        ...
        <div>
            ...
            <textarea 
                ...
                rows="2" 
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ><?= esc_html($offer['conditions'] ?? '') ?></textarea>
        </div>
